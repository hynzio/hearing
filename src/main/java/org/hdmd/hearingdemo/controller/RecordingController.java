...
public class RecordingController {
    ...
    public ResponseEntity<Recording> processRecording(@RequestBody UploadDTO uploadDTO) throws Exception {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "존재하지 않는 데이터"),
                    @ApiResponse(responseCode = "500", description = "서버 오류")})
    public ResponseEntity<String> userReview(@RequestBody RecordingSendDTO recordingSendDTO) throws SQLException {
